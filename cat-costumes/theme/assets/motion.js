...
(function(){
  ...
  document.addEventListener("click", e => { const b = e.target.closest("#add, [data-s-add], .qadd:not(.notify):not(a), #product-form button[type=submit]"); if(b) setTimeout(() => flyToCart(b), 0); });
